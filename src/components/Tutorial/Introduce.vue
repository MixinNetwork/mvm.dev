<template>
  <div>
    ...
    <div class="mt-10">
      <h2>开源代码</h2>
      <div class="mt-2">
        <a class="content link" href="https://github.com/MixinNetwork/safe/tree/main/computer" target="_blank">
          Computer
        </a>
        <a class="content link" href="https://github.com/MixinNetwork/bot-api-nodejs-client" target="_blank">
          Mixin Node SDK
        </a>
      </div>
    </div>
